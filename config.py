...
# ── Дзен: 1 статья-лонгрид в день ──────────────────────────────────────────────
CONTENT_ZEN_HOUR = int(os.getenv("CONTENT_ZEN_HOUR", "12"))   # днём, MSK
# Недельный план Дзена: weekday (0=Пн … 6=Вс) → рубрика статьи. 5 рубрик на 7 дней;
# «Разоблачение» (детектор буллшита) — сильнейшая тема бренда, поэтому чаще.
CONTENT_ZEN_WEEK_PLAN = {
    0: "zen_scam",      # Пн  Разоблачение
    1: "zen_explain",   # Вт  Объяснение
    2: "zen_pain",      # Ср  Болевая тема
    3: "zen_mistakes",  # Чт  Ошибки новичка
    4: "zen_story",     # Пт  Личный путь
    5: "zen_scam",      # Сб  Разоблачение
    6: "zen_pain",      # Вс  Болевая тема
}
