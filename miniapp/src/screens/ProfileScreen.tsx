...
// Иерархия ценности: скорость и доступ ко мне сверху (то, чего нет у брокера),
// AI — бонусом снизу (его базово раздают бесплатно). Без необъявленных обещаний.
const PREMIUM = [
  "Пуш о моей сделке раньше канала — видишь первым",
  "«Нелюбимчик недели»: перепроданный актив, разбор за и против",
  "Умные предупреждения о рынке: перегрев, паника, риск",
  "Вопрос мне напрямую без лимита (бесплатно — 1 в день)",
  "AI-разбор и сценарии по твоему портфелю — бонусом",
];
  ...
  return (
    <div className="content">
      ...
      <div className="card premium">
        ...
        <div className="premium-sub">Платишь за доступ ко мне и скорость — не за функции,
          которые есть бесплатно в приложении брокера.</div>
